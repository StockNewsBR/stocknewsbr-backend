...
class Mission28BCommercialReadinessTests(unittest.TestCase):
    def test_master_score_display_clamps_negative_above_ten_ten_and_zero(self):
        self.assertEqual(normalize_master_score_display(-2)[0], 0.0)
        self.assertEqual(normalize_master_score_display(11.7)[0], 10.0)
        self.assertEqual(normalize_master_score_display(12.0)[0], 10.0)
        self.assertEqual(normalize_master_score_display(15.0)[0], 10.0)
    ...
    def test_snapshot_contract_exposes_display_safe_score(self):
        ...
        self.assertEqual(payload["master_score"], 12.0)
        self.assertEqual(payload["master_score_display"], 10.0)
        self.assertEqual(payload["master_score_display_warning"], "master_score_display_clamped_above_10")
    ...
    def test_ranking_exposes_display_safe_score_without_changing_raw_score(self):
        ...
        self.assertEqual(payload[0]["master_score_display"], 10.0)
        self.assertEqual(payload[0]["master_score_display_warning"], "master_score_display_clamped_above_10")
    ...
    def test_performance_intelligence_keeps_score_bucket_bounded(self):
        self.assertEqual(score_bucket({"master_score": 12.0}), "8-10")
    ...
    def test_warning_is_appended_without_dropping_existing_warnings(self):
        ...
        self.assertIn("master_score_display_clamped_above_10", payload["warnings"])
