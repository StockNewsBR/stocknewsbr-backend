...
def _match_cluster(item: dict[str, Any], candidate_clusters: list[dict[str, Any]]) -> dict[str, Any] | None:
...
def _cluster_news(items: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    for item in items:
        ...
        candidate_clusters = _find_candidate_clusters(
            story_key,
            token_keys,
            story_index,
            token_index,
        ...
        matched_cluster = _match_cluster(item, candidate_clusters)
    ...
    for cluster in clusters:
        results.append(_finalize_cluster(cluster))
